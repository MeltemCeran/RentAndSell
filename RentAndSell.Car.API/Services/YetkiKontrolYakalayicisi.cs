...
namespace RentAndSell.Car.API.Services
{
    public class YetkiKontrolYakalayicisi : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        public YetkiKontrolYakalayicisi(IOptionsMonitor<AuthenticationSchemeOptions> options, ILoggerFactory logger, UrlEncoder encoder, UserManager<Kullanici> userManager, RoleManager<IdentityRole> roleManager, SignInManager<Kullanici> signInManager = null) : base(options, logger, encoder)
        {
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            {
                string authorication = Request.Headers["Authorization"];
                ...
                if (signInResult.IsNotAllowed)
                    return AuthenticateResult.Fail("Hesabınız henüz doğrulanmamıştır. Lütfen mailinize gelen linke tıklayınız.");
